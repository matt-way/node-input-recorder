...
$(builddir)/input-recorder.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/input-recorder.node: TOOLSET := $(TOOLSET)
$(builddir)/input-recorder.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/input-recorder.node
# Add target alias
.PHONY: input-recorder
input-recorder: $(builddir)/input-recorder.node

# Short alias for building this executable.
.PHONY: input-recorder.node
input-recorder.node: $(builddir)/input-recorder.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/input-recorder.node
